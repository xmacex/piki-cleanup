...
declare variable $allowedFunctionTerms := ('A', 'äänitt.', 'anim.', 'B', 'Bar', 'dramat.', 'esitt.', 'graaf.', 'joht.', 'käänt.', 'kaivert.', 'käsik.', 'kert.', 'kok.', 'koreogr.', 'Kt', 'kuv.', 'kuvatait.', 'laulu', 'lausuja', 'lav.', 'leikk.', 'lukija', 'miks.', 'mus.', 'Mz', 'näytt.', 'ohj.', 'opett.', 'piirt.', 'poikasopraano', 'S', 'san.', 'säv.', 'sorm.', 'sov.', 'suunn.', 'T', 'tanssi', 'täyd.', 'toim.', 'transkr.', 'tuott.', 'valok.');
